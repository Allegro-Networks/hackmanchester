    ...
    },
    {
		...
		var map_config = {
            ...
            code: { locationName: 'Code Computerlove', centreLat:53.4823168, centreLng:-2.23693, lat:53.4823756, lng:-2.234742 }
		};
		...
		if (location == 'madlab') {
			config_to_use = map_config.madlab;
		}
        if (location == 'code') {
            config_to_use = map_config.code;
        }
